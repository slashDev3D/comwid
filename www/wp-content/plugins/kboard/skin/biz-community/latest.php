<div id="kboard-biz-community-latest">
	<table>
		<thead>
			<tr>
			...
			<tr>
				<td class="kboard-latest-title">
					<a href="<?php echo $url->getDocumentURLWithUID($content->uid)?>">
						<div class="kboard-biz-community-cut-strings">
							<?php if($content->isNew()):?><span class="kboard-biz-community-new-notify">N</span><?php endif?>
